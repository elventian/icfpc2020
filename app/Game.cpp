...
std::string Game::sendRequest(const std::string &req) const
{
	...
	if (m_offlineMode) {
		static int calls = 0;
		calls++;
		return "";
		if (calls == 1) { return "11011000011101011110111100001000000001101011110111100010000000001101100001110111001000000001111011100001000011011101000000000111101110111111101101100011110110001111011000010000110000"; }
		return "1101100001110110001011110111100001000000001101011110111100010000000001101100001110111001000000001111011100001000011011101000000000111101110111111101101100011110110001111011000010000110000";
	}
	else {
